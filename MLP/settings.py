...
SECRET_KEY = '0j&&6j&$)*4wh^)9rhw1bllta8=f(ascy*o(m3-@c3a9-m-wy5'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(__file__), 'C:/Marco Cosas/ProgrammingHere/Python/Django/MLP/registros/templates'),(
            'C:/Marco Cosas/ProgrammingHere/Python/Django/MLP/MLP/templates/Pages'), ('C:/Marco Cosas/ProgrammingHere/Python/Django/MLP/carro/templates') ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
MEDIA_URL= '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, '/MLP/templates/static/img/media')
